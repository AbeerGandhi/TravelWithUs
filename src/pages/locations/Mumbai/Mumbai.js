...
export const Mumbai = () => {
  ...
  const packageInfo = {
    2: {
      low: { img: MumbaiImages.dp1, location: "Low", price: "2,000 - 5,000", pdf: "/pdfs/mumbai/2MumbaiLow.pdf" },
      medium: { img: MumbaiImages.dp2, location: "Medium", price: "5,000 - 15,000", pdf: "/pdfs/mumbai/2MumbaiMedium.pdf" },
      high: { img: MumbaiImages.dp3, location: "High", price: "15,000 - 30,000", pdf: "/pdfs/mumbai/2MumbaiHigh.pdf" },
    },
    3: {
      low: { img: MumbaiImages.dp1, location: "Low", price: "2,000 - 5,000", pdf: "/pdfs/mumbai/3MumbaiLow.pdf" },
      medium: { img: MumbaiImages.dp2, location: "Medium", price: "5,000 - 15,000", pdf: "/pdfs/mumbai/3MumbaiMedium.pdf" },
      high: { img: MumbaiImages.dp3, location: "High", price: "15,000 - 30,000", pdf: "/pdfs/mumbai/3MumbaiHigh.pdf" },
    },
    4: {
      low: { img: MumbaiImages.dp1, location: "Low", price: "2,000 - 5,000", pdf: "/pdfs/mumbai/4MumbaiLow.pdf" },
      medium: { img: MumbaiImages.dp2, location: "Medium", price: "5,000 - 15,000", pdf: "/pdfs/mumbai/4MumbaiMedium.pdf" },
      high: { img: MumbaiImages.dp3, location: "High", price: "15,000 - 30,000", pdf: "/pdfs/mumbai/4MumbaiHigh.pdf" },
    },
  };
  ...
  const handleLocationSubmit = async (e) => {
    ...
    try {
      ...
      if (data.results.length > 0) {
        ...
        const mumbaiCoords = { latitude: 19.0760, longitude: 72.8777 }; // Coordinates for Mumbai
