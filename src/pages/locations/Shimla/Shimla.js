  ...
  const packageInfo = {
    2: {
      low: {
        ...
        pdf: "/pdfs/shimla/2ShimlaLow.html", // Updated to point to the HTML file
      },
      medium: {
        img: ShimlaImages.dp2,
        location: "Medium",
        price: "INR 5,000 - 15,000",
        pdf: "/pdfs/shimla/2ShimlaMedium.html", // Updated to point to the HTML file
      },
      high: {
        img: ShimlaImages.dp3,
        location: "High",
        price: "INR 15,000 - 30,000",
        pdf: "/pdfs/shimla/2ShimlaHigh.html", // Updated to point to the HTML file
      },
    },
    3: {
      low: {
        ...
        location: "Low",
        price: "INR 2,000 - 5,000",
        pdf: "/pdfs/shimla/3ShimlaLow.html", // Updated to point to the HTML file
      },
      medium: {
        img: ShimlaImages.dp2,
        location: "Medium",
        price: "INR 5,000 - 15,000",
        pdf: "/pdfs/shimla/3ShimlaMedium.html", // Updated to point to the HTML file
      },
      high: {
        img: ShimlaImages.dp3,
        location: "High",
        price: "INR 15,000 - 30,000",
        pdf: "/pdfs/shimla/3ShimlaHigh.html", // Updated to point to the HTML file
      },
    },
    4: {
      low: {
        ...
        location: "Low",
        price: "INR 2,000 - 5,000",
        pdf: "/pdfs/shimla/4ShimlaLow.html", // Updated to point to the HTML file
      },
      medium: {
        img: ShimlaImages.dp2,
        location: "Medium",
        price: "INR 5,000 - 15,000",
        pdf: "/pdfs/shimla/4ShimlaMedium.html", // Updated to point to the HTML file
      },
      high: {
        img: ShimlaImages.dp3,
        location: "High",
        price: "INR 15,000 - 30,000",
        pdf: "/pdfs/shimla/4ShimlaHigh.html", // Updated to point to the HTML file
      },
    },
  };
  ...
  const handleLocationSubmit = async (e) => {
    ...
    try {
      ...
      if (data.results.length > 0) {
        ...
        const shimlaCoords = { latitude: 31.1048, longitude: 77.1734 }; // Coordinates for Shimla
