...
export const Nashik = () => {
  ...
  const packageInfo = {
    2: {
      low: { img: NashikImages.dp1, location: "Low", price: "2,000 - 5,000", pdf: "/pdfs/nashik/2NashikLow.pdf" },
      medium: { img: NashikImages.dp2, location: "Medium", price: "5,000 - 15,000", pdf: "/pdfs/nashik/2NashikMedium.pdf" },
      high: { img: NashikImages.dp3, location: "High", price: "15,000 - 30,000", pdf: "/pdfs/nashik/2NashikHigh.pdf" },
    },
    3: {
      low: { img: NashikImages.dp1, location: "Low", price: "2,000 - 5,000", pdf: "/pdfs/nashik/3NashikLow.pdf" },
      medium: { img: NashikImages.dp2, location: "Medium", price: "5,000 - 15,000", pdf: "/pdfs/nashik/3NashikMedium.pdf" },
      high: { img: NashikImages.dp3, location: "High", price: "15,000 - 30,000", pdf: "/pdfs/nashik/3NashikHigh.pdf" },
    },
    4: {
      low: { img: NashikImages.dp1, location: "Low", price: "2,000 - 5,000", pdf: "/pdfs/nashik/4NashikLow.pdf" },
      medium: { img: NashikImages.dp2, location: "Medium", price: "5,000 - 15,000", pdf: "/pdfs/nashik/4NashikMedium.pdf" },
      high: { img: NashikImages.dp3, location: "High", price: "15,000 - 30,000", pdf: "/pdfs/nashik/4NashikHigh.pdf" },
    },
  };
  ...
  const handleLocationSubmit = async (e) => {
    ...
    try {
      ...
      if (data.results.length > 0) {
        ...
        const nashikCoords = { latitude: 19.9975, longitude: 73.7898 }; // Coordinates for Nashik
