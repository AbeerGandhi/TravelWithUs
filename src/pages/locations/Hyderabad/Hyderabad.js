  ...
  const packageInfo = {
    2: {
      low: {
        ...
        location: "Low",
        price: "2,000 - 5,000",
        pdf: "/pdfs/hyderabad/2_days_trip_in_hyderabad_low.pdf", // Updated to point to the PDF file
      },
      medium: {
        img: HyderabadImages.dp2,
        location: "Medium",
        price: "5,000 - 15,000",
        pdf: "/pdfs/hyderabad/2_days_trip_in_hyderabad_medium.pdf", // Updated to point to the PDF file
      },
      high: {
        img: HyderabadImages.dp3,
        location: "High",
        price: "15,000 - 30,000",
        pdf: "/pdfs/hyderabad/2_days_trip_in_hyderabad_high.pdf", // Updated to point to the PDF file
      },
    },
    3: {
      low: {
        ...
        location: "Low",
        price: "2,000 - 5,000",
        pdf: "/pdfs/hyderabad/3_days_trip_in_hyderabad_low.pdf", // Updated to point to the PDF file
      },
      medium: {
        img: HyderabadImages.dp2,
        location: "Medium",
        price: "5,000 - 15,000",
        pdf: "/pdfs/hyderabad/3_days_trip_in_hyderabad_medium.pdf", // Updated to point to the PDF file
      },
      high: {
        img: HyderabadImages.dp3,
        location: "High",
        price: "15,000 - 30,000",
        pdf: "/pdfs/hyderabad/3_days_trip_in_hyderabad_high.pdf", // Updated to point to the PDF file
      },
    },
    4: {
      low: {
        ...
        location: "Low",
        price: "2,000 - 5,000",
        pdf: "/pdfs/hyderabad/4_days_trip_in_hyderabad_low.pdf", // Updated to point to the PDF file
      },
      medium: {
        img: HyderabadImages.dp2,
        location: "Medium",
        price: "5,000 - 15,000",
        pdf: "/pdfs/hyderabad/4_days_trip_in_hyderabad_medium.pdf", // Updated to point to the PDF file
      },
      high: {
        img: HyderabadImages.dp3,
        location: "High",
        price: "15,000 - 30,000",
        pdf: "/pdfs/hyderabad/4_days_trip_in_hyderabad_high.pdf", // Updated to point to the PDF file
      },
    },
  };
  ...
  const handleLocationSubmit = async (e) => {
    ...
    try {
      ...
      if (data.results.length > 0) {
        ...
        const hyderabadCoords = { latitude: 17.3850, longitude: 78.4867 }; // Coordinates for Hyderabad
