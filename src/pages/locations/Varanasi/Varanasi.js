...
export const Varanasi = () => {
  ...
  const packageInfo = {
    2: {
      low: { img: VaranasiImages.dp1, location: "Low", price: "2,000 - 5,000", pdf: "/pdfs/varanasi/2daylowvaranasi.pdf" },
      medium: { img: VaranasiImages.dp2, location: "Medium", price: "5,000 - 15,000", pdf: "/pdfs/varanasi/2daymediumvaranasi.pdf" },
      high: { img: VaranasiImages.dp3, location: "High", price: "15,000 - 30,000", pdf: "/pdfs/varanasi/2dayhighvaranasi.pdf" },
    },
    3: {
      low: { img: VaranasiImages.dp1, location: "Low", price: "2,000 - 5,000", pdf: "/pdfs/varanasi/3daylowvaranasi.pdf" },
      medium: { img: VaranasiImages.dp2, location: "Medium", price: "5,000 - 15,000", pdf: "/pdfs/varanasi/3daymediumvaranasi.pdf" },
      high: { img: VaranasiImages.dp3, location: "High", price: "15,000 - 30,000", pdf: "/pdfs/varanasi/3dayhighvaranasi.pdf" },
    },
    4: {
      low: { img: VaranasiImages.dp1, location: "Low", price: "2,000 - 5,000", pdf: "/pdfs/varanasi/4daylowvaranasi.pdf" },
      medium: { img: VaranasiImages.dp2, location: "Medium", price: "5,000 - 15,000", pdf: "/pdfs/varanasi/4daymediumvaranasi.pdf" },
      high: { img: VaranasiImages.dp3, location: "High", price: "15,000 - 30,000", pdf: "/pdfs/varanasi/4dayhighvaranasi.pdf" },
    },
  };
  ...
  const handleLocationSubmit = async (e) => {
    ...
    try {
      ...
      if (data.results.length > 0) {
        ...
        const varanasiCoords = { latitude: 25.3176, longitude: 82.9739 }; // Coordinates for Varanasi
