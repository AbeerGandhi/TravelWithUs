...
export const Delhi = () => {
  ...
  const packageInfo = {
    2: {
      low: { img: DelhiImages.dp1, location: "Low", price: "2,000 - 5,000", pdf: "/pdfs/delhi/2_days_trip_in_delhi_low.pdf" },
      medium: { img: DelhiImages.dp2, location: "Medium", price: "5,000 - 15,000", pdf: "/pdfs/delhi/2_days_trip_in_delhi_medium.pdf" },
      high: { img: DelhiImages.dp3, location: "High", price: "15,000 - 30,000", pdf: "/pdfs/delhi/2_days_trip_in_delhi_high.pdf" },
    },
    3: {
      low: { img: DelhiImages.dp1, location: "Low", price: "2,000 - 5,000", pdf: "/pdfs/delhi/3_days_trip_in_delhi_low.pdf" },
      medium: { img: DelhiImages.dp2, location: "Medium", price: "5,000 - 15,000", pdf: "/pdfs/delhi/3_days_trip_in_delhi_medium.pdf" },
      high: { img: DelhiImages.dp3, location: "High", price: "15,000 - 30,000", pdf: "/pdfs/delhi/3_days_trip_in_delhi_high.pdf" },
    },
    4: {
      low: { img: DelhiImages.dp1, location: "Low", price: "2,000 - 5,000", pdf: "/pdfs/delhi/4_days_trip_in_delhi_low.pdf" },
      medium: { img: DelhiImages.dp2, location: "Medium", price: "5,000 - 15,000", pdf: "/pdfs/delhi/4_days_trip_in_delhi_medium.pdf" },
      high: { img: DelhiImages.dp3, location: "High", price: "15,000 - 30,000", pdf: "/pdfs/delhi/4_days_trip_in_delhi_high.pdf" },
    },
  };
  ...
  const handleLocationSubmit = async (e) => {
    ...
    try {
      ...
      if (data.results.length > 0) {
        ...
        const delhiCoords = { latitude: 28.6139, longitude: 77.2090 }; // Coordinates for Delhi
  ...
  return (
    <>
      ...
      <div className="t-info">
        <h2>
          <span id="diff">E</span>verything you need to know about Delhi
          <hr />
        </h2>
