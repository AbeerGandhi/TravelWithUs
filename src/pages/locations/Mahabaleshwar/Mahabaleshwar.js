...
export const Mahabaleshwar = () => {
  ...
  const packageInfo = {
    2: {
      low: { img: MahabaleshwarImages.dp1, location: "Low", price: "2,000 - 5,000", pdf: "/pdfs/mahabaleshwar/2MahabaleshwarLow.pdf" },
      medium: { img: MahabaleshwarImages.dp2, location: "Medium", price: "5,000 - 15,000", pdf: "/pdfs/mahabaleshwar/2MahabaleshwarMedium.pdf" },
      high: { img: MahabaleshwarImages.dp3, location: "High", price: "15,000 - 30,000", pdf: "/pdfs/mahabaleshwar/2MahabaleshwarHigh.pdf" },
    },
    3: {
      low: { img: MahabaleshwarImages.dp1, location: "Low", price: "2,000 - 5,000", pdf: "/pdfs/mahabaleshwar/3MahabaleshwarLow.pdf" },
      medium: { img: MahabaleshwarImages.dp2, location: "Medium", price: "5,000 - 15,000", pdf: "/pdfs/mahabaleshwar/3MahabaleshwarMedium.pdf" },
      high: { img: MahabaleshwarImages.dp3, location: "High", price: "15,000 - 30,000", pdf: "/pdfs/mahabaleshwar/3MahabaleshwarHigh.pdf" },
    },
    4: {
      low: { img: MahabaleshwarImages.dp1, location: "Low", price: "2,000 - 5,000", pdf: "/pdfs/mahabaleshwar/4MahabaleshwarLow.pdf" },
      medium: { img: MahabaleshwarImages.dp2, location: "Medium", price: "5,000 - 15,000", pdf: "/pdfs/mahabaleshwar/4MahabaleshwarMedium.pdf" },
      high: { img: MahabaleshwarImages.dp3, location: "High", price: "15,000 - 30,000", pdf: "/pdfs/mahabaleshwar/4MahabaleshwarHigh.pdf" },
    },
  };
  ...
  const determineBudget = (distance) => {
    if (distance < 500) {
      return { Budget: "Low (By Car)", CostRange: "(2,000 - 5,000)" };
    } else if (distance < 1500) {
      return { Budget: "Medium (By Bus)", CostRange: "(5,000 - 15,000)" };
    } else {
      return { Budget: "High (By Train)", CostRange: "(15,000 - 30,000)" };
    }
  };
  ...
  const handleLocationSubmit = async (e) => {
    ...
    try {
      ...
      if (data.results.length > 0) {
        ...
        const mahabaleshwarCoords = { latitude: 17.058, longitude: 73.652 }; // Coordinates for Mahabaleshwar
