  ...
  const packageInfo = {
    2: {
        low: { 
            ...
            location: "Low", 
            price: "2,000 - 5,000", 
            pdf: "/pdfs/alleppey/2alleppeylow.html" 
        },
        medium: { 
            img: AlleppeyImages.dp2, 
            location: "Medium", 
            price: "5,000 - 15,000", 
            pdf: "/pdfs/alleppey/2alleppeymedium.html" 
        },
        high: { 
            img: AlleppeyImages.dp3, 
            location: "High", 
            price: "15,000 - 30,000", 
            pdf: "/pdfs/alleppey/2alleppeyhigh.html" 
        },
    },
    3: {
        low: { 
            ...
            location: "Low", 
            price: "2,000 - 5,000", 
            pdf: "/pdfs/alleppey/3alleppeylow.html" 
        },
        medium: { 
            img: AlleppeyImages.dp2, 
            location: "Medium", 
            price: "5,000 - 15,000", 
            pdf: "/pdfs/alleppey/3alleppeymedium.html" 
        },
        high: { 
            img: AlleppeyImages.dp3, 
            location: "High", 
            price: "15,000 - 30,000", 
            pdf: "/pdfs/alleppey/3alleppeyhigh.html" 
        },
    },
    4: {
        low: { 
            ...
            location: "Low", 
            price: "2,000 - 5,000", 
            pdf: "/pdfs/alleppey/4alleppeylow.html" 
        },
        medium: { 
            img: AlleppeyImages.dp2, 
            location: "Medium", 
            price: "5,000 - 15,000", 
            pdf: "/pdfs/alleppey/4alleppeymedium.html" 
        },
        high: { 
            img: AlleppeyImages.dp3, 
            location: "High", 
            price: "15,000 - 30,000", 
            pdf: "/pdfs/alleppey/4alleppeyhigh.html" 
        },
    },
};
  ...
  const handleLocationSubmit = async (e) => {
    ...
    try {
      ...
      if (data.results.length > 0) {
        ...
        const alleppeyCoords = { latitude: 9.4981, longitude: 76.3388 }; // Coordinates for Alleppey
