...
export const Rajasthan = () => {
  ...
  const packageInfo = {
    2: {
      low: { img: RajasthanImages.dp1, location: "City Palace, Jaipur", price: "INR 500 - 1,000", pdf: "/pdfs/rajasthan/2daylowrajasthan.pdf" },
      medium: { img: RajasthanImages.dp2, location: "Camel Safari", price: "INR 1,000 - 2,500", pdf: "/pdfs/rajasthan/2daymediumrajasthan.pdf" },
      high: { img: RajasthanImages.dp3, location: "Heritage Hotel Stay", price: "INR 2,500 - 5,000", pdf: "/pdfs/rajasthan/2dayhighrajasthan.pdf" },
    },
    3: {
      low: { img: RajasthanImages.dp1, location: "City Palace, Jaipur", price: "INR 2,000 - 5,000", pdf: "/pdfs/rajasthan/3daylowrajasthan.pdf" },
      medium: { img: RajasthanImages.dp2, location: "Camel Safari", price: "INR 5,000 - 15,000", pdf: "/pdfs/rajasthan/3daymediumrajasthan.pdf" },
      high: { img: RajasthanImages.dp3, location: "Heritage Hotel Stay", price: "INR 15,000 - 30,000", pdf: "/pdfs/rajasthan/3dayhighrajasthan.pdf" },
    },
    4: {
      low: { img: RajasthanImages.dp1, location: "City Palace, Jaipur", price: "INR 2,000 - 5,000", pdf: "/pdfs/rajasthan/4daylowrajasthan.pdf" },
      medium: { img: RajasthanImages.dp2, location: "Camel Safari", price: "INR 5,000 - 15,000", pdf: "/pdfs/rajasthan/4daymediumrajasthan.pdf" },
      high: { img: RajasthanImages.dp3, location: "Heritage Hotel Stay", price: "INR 15,000 - 30,000", pdf: "/pdfs/rajasthan/4dayhighrajasthan.pdf" },
    },
  };
  ...
  const handleLocationSubmit = async (e) => {
    ...
    try {
      ...
      if (data.results.length > 0) {
        ...
        const rajasthanCoords = { latitude: 27.0238, longitude: 74.2179 }; // Coordinates for Rajasthan
  ...
  return (
    <>
      ...
      <div className="t-info">
        <h2>
          <span id="diff">E</span>verything you need to know about Rajasthan
          <hr />
        </h2>
        <div className="t-row">
