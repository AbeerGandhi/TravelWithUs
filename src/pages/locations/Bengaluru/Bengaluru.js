  ...
  const packageInfo = {
    2: {
        low: { 
            ...
            location: "Low", 
            price: "2,000 - 5,000", 
            pdf: "/pdfs/bengaluru/2_days_trip_in_bengaluru_low.pdf" 
        },
        medium: { 
            img: BengaluruImages.dp2, 
            location: "Medium", 
            price: "5,000 - 15,000", 
            pdf: "/pdfs/bengaluru/2_days_trip_in_bengaluru_medium.pdf" 
        },
        high: { 
            img: BengaluruImages.dp3, 
            location: "High", 
            price: "15,000 - 30,000", 
            pdf: "/pdfs/bengaluru/2_days_trip_in_bengaluru_high.pdf" 
        },
    },
    3: {
        low: { 
            ...
            location: "Low", 
            price: "2,000 - 5,000", 
            pdf: "/pdfs/bengaluru/3_days_trip_in_bengaluru_low.pdf" 
        },
        medium: { 
            img: BengaluruImages.dp2, 
            location: "Medium", 
            price: "5,000 - 15,000", 
            pdf: "/pdfs/bengaluru/3_days_trip_in_bengaluru_medium.pdf" 
        },
        high: { 
            img: BengaluruImages.dp3, 
            location: "High", 
            price: "15,000 - 30,000", 
            pdf: "/pdfs/bengaluru/3_days_trip_in_bengaluru_high.pdf" 
        },
    },
    4: {
        low: { 
            ...
            location: "Low", 
            price: "2,000 - 5,000", 
            pdf: "/pdfs/bengaluru/4_days_trip_in_bengaluru_low.pdf" 
        },
        medium: { 
            img: BengaluruImages.dp2, 
            location: "Medium", 
            price: "5,000 - 15,000", 
            pdf: "/pdfs/bengaluru/4_days_trip_in_bengaluru_medium.pdf" 
        },
        high: { 
            img: BengaluruImages.dp3, 
            location: "High", 
            price: "15,000 - 30,000", 
            pdf: "/pdfs/bengaluru/4_days_trip_in_bengaluru_high.pdf" 
        },
    },
};
  ...
  const handleLocationSubmit = async (e) => {
    ...
    try {
      ...
      if (data.results.length > 0) {
        ...
        const bengaluruCoords = { latitude: 12.9716, longitude: 77.5946 }; // Coordinates for Bengaluru
