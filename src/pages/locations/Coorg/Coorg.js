...
export const Coorg = () => {
  ...
  const packageInfo = {
    2: {
      low: { img: CoorgImages.dp1, location: "Low", price: "2,000 - 5,000", pdf: "/pdfs/coorg/2daylowcoorg.pdf" },
      medium: { img: CoorgImages.dp2, location: "Medium", price: "5,000 - 15,000", pdf: "/pdfs/coorg/2daymediumcoorg.pdf" },
      high: { img: CoorgImages.dp3, location: "High", price: "15,000 - 30,000", pdf: "/pdfs/coorg/2dayhighcoorg.pdf" },
    },
    3: {
      low: { img: CoorgImages.dp1, location: "Low", price: "2,000 - 5,000", pdf: "/pdfs/coorg/3daylowcoorg.pdf" },
      medium: { img: CoorgImages.dp2, location: "Medium", price: "5,000 - 15,000", pdf: "/pdfs/coorg/3daymediumcoorg.pdf" },
      high: { img: CoorgImages.dp3, location: "High", price: "15,000 - 30,000", pdf: "/pdfs/coorg/3dayhighcoorg.pdf" },
    },
    4: {
      low: { img: CoorgImages.dp1, location: "Low", price: "2,000 - 5,000", pdf: "/pdfs/coorg/4daylowcoorg.pdf" },
      medium: { img: CoorgImages.dp2, location: "Medium", price: "5,000 - 15,000", pdf: "/pdfs/coorg/4daymediumcoorg.pdf" },
      high: { img: CoorgImages.dp3, location: "High", price: "15,000 - 30,000", pdf: "/pdfs/coorg/4dayhighcoorg.pdf" },
    },
  };
  ...
  const handleLocationSubmit = async (e) => {
    ...
    try {
      ...
      if (data.results.length > 0) {
        ...
        const coorgCoords = { latitude: 12.3375, longitude: 75.8069 }; // Coordinates for Coorg
