...
export const Lakshadweep = () => {
  ...
  const packageInfo = {
    2: {
      low: { img: LakshadweepImages.dp1, location: "Low", price: "5,000 - 8,000", pdf: "/pdfs/lakshadweep/2LakshadweepLow.html" },
      medium: { img: LakshadweepImages.dp2, location: "Medium", price: "8,000 - 15,000", pdf: "/pdfs/lakshadweep/2LakshadweepMedium.html" },
      high: { img: LakshadweepImages.dp3, location: "High", price: "15,000 - 25,000", pdf: "/pdfs/lakshadweep/2LakshadweepHigh.html" },
    },
    3: {
      low: { img: LakshadweepImages.dp1, location: "Low", price: "5,000 - 8,000", pdf: "/pdfs/lakshadweep/3LakshadweepLow.html" },
      medium: { img: LakshadweepImages.dp2, location: "Medium", price: "8,000 - 15,000", pdf: "/pdfs/lakshadweep/3LakshadweepMedium.html" },
      high: { img: LakshadweepImages.dp3, location: "High", price: "15,000 - 25,000", pdf: "/pdfs/lakshadweep/3LakshadweepHigh.html" },
    },
    4: {
      low: { img: LakshadweepImages.dp1, location: "Low", price: "5,000 - 8,000", pdf: "/pdfs/lakshadweep/4LakshadweepLow.html" },
      medium: { img: LakshadweepImages.dp2, location: "Medium", price: "8,000 - 15,000", pdf: "/pdfs/lakshadweep/4LakshadweepMedium.html" },
      high: { img: LakshadweepImages.dp3, location: "High", price: "15,000 - 25,000", pdf: "/pdfs/lakshadweep/4LakshadweepHigh.html" },
    },
  };
  ...
  const determineBudget = (distance) => {
    if (distance < 500) {
      return { Budget: "Low (By Boat)", CostRange: "(5,000 - 8,000)" };
    } else if (distance < 1500) {
      return { Budget: "Medium (By Flight)", CostRange: "(8,000 - 15,000)" };
    } else {
      return { Budget: "High (By Flight)", CostRange: "(15,000 - 25,000)" };
    }
  };
  ...
  const handleLocationSubmit = async (e) => {
    ...
    try {
      ...
      if (data.results.length > 0) {
        ...
        const lakshadweepCoords = { latitude: 10.566, longitude: 72.641 }; // Coordinates for Lakshadweep
