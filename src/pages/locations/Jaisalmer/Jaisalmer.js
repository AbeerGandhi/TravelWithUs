...
export const Jaisalmer = () => {
  ...
  const packageInfo = {
    2: {
      low: { img: JaisalmerImages.dp1, location: "Low", price: "2,000 - 5,000", pdf: "/pdfs/jaisalmer/2JaisalmerLow.pdf" },
      medium: { img: JaisalmerImages.dp2, location: "Medium", price: "5,000 - 15,000", pdf: "/pdfs/jaisalmer/2JaisalmerMedium.pdf" },
      high: { img: JaisalmerImages.dp3, location: "High", price: "15,000 - 30,000", pdf: "/pdfs/jaisalmer/2JaisalmerHigh.pdf" },
    },
    3: {
      low: { img: JaisalmerImages.dp1, location: "Low", price: "2,000 - 5,000", pdf: "/pdfs/jaisalmer/3JaisalmerLow.pdf" },
      medium: { img: JaisalmerImages.dp2, location: "Medium", price: "5,000 - 15,000", pdf: "/pdfs/jaisalmer/3JaisalmerMedium.pdf" },
      high: { img: JaisalmerImages.dp3, location: "High", price: "15,000 - 30,000", pdf: "/pdfs/jaisalmer/3JaisalmerHigh.pdf" },
    },
    4: {
      low: { img: JaisalmerImages.dp1, location: "Low", price: "2,000 - 5,000", pdf: "/pdfs/jaisalmer/4JaisalmerLow.pdf" },
      medium: { img: JaisalmerImages.dp2, location: "Medium", price: "5,000 - 15,000", pdf: "/pdfs/jaisalmer/4JaisalmerMedium.pdf" },
      high: { img: JaisalmerImages.dp3, location: "High", price: "15,000 - 30,000", pdf: "/pdfs/jaisalmer/4JaisalmerHigh.pdf" },
    },
  };
  ...
  const handleLocationSubmit = async (e) => {
    ...
    try {
      ...
      if (data.results.length > 0) {
        ...
        const jaisalmerCoords = { latitude: 26.9157, longitude: 70.9083 }; // Coordinates for Jaisalmer
