...
export const Ooty = () => {
  ...
  const packageInfo = {
    2: {
      low: { img: OotyImages.dp1, location: "Low", price: "2,000 - 5,000", pdf: "/pdfs/ooty/2OotyLow.pdf" },
      medium: { img: OotyImages.dp2, location: "Medium", price: "5,000 - 15,000", pdf: "/pdfs/ooty/2OotyMedium.pdf" },
      high: { img: OotyImages.dp3, location: "High", price: "15,000 - 30,000", pdf: "/pdfs/ooty/2OotyHigh.pdf" },
    },
    3: {
      low: { img: OotyImages.dp1, location: "Low", price: "2,000 - 5,000", pdf: "/pdfs/ooty/3OotyLow.pdf" },
      medium: { img: OotyImages.dp2, location: "Medium", price: "5,000 - 15,000", pdf: "/pdfs/ooty/3OotyMedium.pdf" },
      high: { img: OotyImages.dp3, location: "High", price: "15,000 - 30,000", pdf: "/pdfs/ooty/3OotyHigh.pdf" },
    },
    4: {
      low: { img: OotyImages.dp1, location: "Low", price: "2,000 - 5,000", pdf: "/pdfs/ooty/4OotyLow.pdf" },
      medium: { img: OotyImages.dp2, location: "Medium", price: "5,000 - 15,000", pdf: "/pdfs/ooty/4OotyMedium.pdf" },
      high: { img: OotyImages.dp3, location: "High", price: "15,000 - 30,000", pdf: "/pdfs/ooty/4OotyHigh.pdf" },
    },
  };
  ...
  const handleLocationSubmit = async (e) => {
    ...
    try {
      ...
      if (data.results.length > 0) {
        ...
        const ootyCoords = { latitude: 11.4132, longitude: 76.6937 }; // Coordinates for Ooty
