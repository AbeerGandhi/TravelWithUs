  ...
  const packageInfo = {
    2: {
        low: { 
            ...
            location: "Low", 
            price: "2,000 - 5,000", 
            pdf: "/pdfs/ajmer/2ajmerlow.html" 
        },
        medium: { 
            img: AjmerImages.dp2, 
            location: "Medium", 
            price: "5,000 - 15,000", 
            pdf: "/pdfs/ajmer/2ajmermedium.html" 
        },
        high: { 
            img: AjmerImages.dp3, 
            location: "High", 
            price: "15,000 - 30,000", 
            pdf: "/pdfs/ajmer/2ajmerhigh.html" 
        },
    },
    3: {
        low: { 
            ...
            location: "Low", 
            price: "2,000 - 5,000", 
            pdf: "/pdfs/ajmer/3ajmerlow.html" 
        },
        medium: { 
            img: AjmerImages.dp2, 
            location: "Medium", 
            price: "5,000 - 15,000", 
            pdf: "/pdfs/ajmer/3ajmermedium.html" 
        },
        high: { 
            img: AjmerImages.dp3, 
            location: "High", 
            price: "15,000 - 30,000", 
            pdf: "/pdfs/ajmer/3ajmerhigh.html" 
        },
    },
    4: {
        low: { 
            ...
            location: "Low", 
            price: "2,000 - 5,000", 
            pdf: "/pdfs/ajmer/4ajmerlow.html" 
        },
        medium: { 
            img: AjmerImages.dp2, 
            location: "Medium", 
            price: "5,000 - 15,000", 
            pdf: "/pdfs/ajmer/4ajmermedium.html" 
        },
        high: { 
            img: AjmerImages.dp3, 
            location: "High", 
            price: "15,000 - 30,000", 
            pdf: "/pdfs/ajmer/4ajmerhigh.html" 
        },
    },
};
  ...
  const handleLocationSubmit = async (e) => {
    ...
    try {
      ...
      if (data.results.length > 0) {
        ...
        const ajmerCoords = { latitude: 26.4499, longitude: 74.6399 }; // Coordinates for Ajmer
