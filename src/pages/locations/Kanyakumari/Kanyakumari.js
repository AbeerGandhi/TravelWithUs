  ...
  const packageInfo = {
    2: {
      low: {
        ...
        location: "Low",
        price: "2,000 - 5,000",
        pdf: "/pdfs/kanyakumari/2kanyakumarilow.html", // Updated to point to the HTML file
      },
      medium: {
        img: KanyakumariImages.dp2,
        location: "Medium",
        price: "5,000 - 15,000",
        pdf: "/pdfs/kanyakumari/2kanyakumarimedium.html", // Updated to point to the HTML file
      },
      high: {
        img: KanyakumariImages.dp3,
        location: "High",
        price: "15,000 - 30,000",
        pdf: "/pdfs/kanyakumari/2kanyakumarihigh.html", // Updated to point to the HTML file
      },
    },
    3: {
      low: {
        ...
        location: "Low",
        price: "2,000 - 5,000",
        pdf: "/pdfs/kanyakumari/3kanyakumarilow.html", // Updated to point to the HTML file
      },
      medium: {
        img: KanyakumariImages.dp2,
        location: "Medium",
        price: "5,000 - 15,000",
        pdf: "/pdfs/kanyakumari/3kanyakumarimedium.html", // Updated to point to the HTML file
      },
      high: {
        img: KanyakumariImages.dp3,
        location: "High",
        price: "15,000 - 30,000",
        pdf: "/pdfs/kanyakumari/3kanyakumarihigh.html", // Updated to point to the HTML file
      },
    },
    4: {
      low: {
        ...
        location: "Low",
        price: "2,000 - 5,000",
        pdf: "/pdfs/kanyakumari/4kanyakumarilow.html", // Updated to point to the HTML file
      },
      medium: {
        img: KanyakumariImages.dp2,
        location: "Medium",
        price: "5,000 - 15,000",
        pdf: "/pdfs/kanyakumari/4kanyakumarimedium.html", // Updated to point to the HTML file
      },
      high: {
        img: KanyakumariImages.dp3,
        location: "High",
        price: "15,000 - 30,000",
        pdf: "/pdfs/kanyakumari/4kanyakumarihigh.html", // Updated to point to the HTML file
      },
    },
  };
  ...
  const handleLocationSubmit = async (e) => {
    ...
    try {
      ...
      if (data.results.length > 0) {
        ...
        const kanyakumariCoords = { latitude: 8.0883, longitude: 77.5385 }; // Coordinates for Kanyakumari
